...
<div class="row">
	...
	<p>ATTACK CARD</p>
		 ...
		 <img src="/resources/images/cards/${game.getUseCard().getName()}.png" alt="card" style="height: 70%; width:auto" />
			...
			<p>${ game.getCurrentPlayer()} te han atacado y te ha hecho ${dano} de da�o</p></c:if>
			<c:if test="${game.getCurrentPlayer().getDamageBonus()>0}">
			<p>${ game.getCurrentPlayer()} te han atacado y te ha hecho ${dano+game.getCurrentPlayer().getDamageBonus()} de da�o (Bonus de da�o incluido)</p></c:if>
		 <img src="/resources/images/cards/${game.getUseCard().getName()}.png" alt="card" style="height: 70%; width:auto" />
