...
INSERT INTO characters(id,name,life,image,text, game_phase) VALUES (1,'Benkei',100,'characters/benkei.png','All other players have +1 Difficulty when they attack you.', 0);
INSERT INTO characters(id,name,life,image,text, game_phase) VALUES (2,'Chiyome',100,'characters/chiyome.png','You can only be wounded by Weapon cards. You are not affected by Jujutsu and Battle Cry cards. You are affected normally by other Action cards, such as Tea Ceremony.',3);
INSERT INTO characters(id,name,life,image,text, game_phase, status) VALUES (3,'Ginchiyo',100,'characters/ginchiyo.png','You take 1 wound less than normal when attacked by any Weapon, to a minimum of 1 wound. E.g., a Nodachi would only deal 2 wounds to you instead of 3, but a Shuriken still inflicts 1 wound.', 4,1);
INSERT INTO characters(id,name,life,image,text, game_phase) VALUES (4,'Goemon',100,'characters/goemon.png','You may play 1 additional Weapon card during your turn. So, if you have 1 Focus in play, you may play up to 3 Weapon cards each turn.',0);
INSERT INTO characters(id,name,life,image,text, game_phase, status) VALUES (5,'Hanzo',100,'characters/hanzo.png','You may play a Weapon card from your hand as a parry , unless it is the only card in your hand. You may use this ability even in response to cards such as Battle Cry.', 4,1);
INSERT INTO characters(id,name,life,image,text) VALUES (6,'Hideyoshi',100,'characters/hideyoshi.png','You may play a Weapon card from your hand as a parry , unless it is the only card in your hand. You may use this ability even in response to cards such as Battle Cry.');
INSERT INTO characters(id,name,life,image,text, game_phase) VALUES (7,'Ieyasu',100,'characters/ieyasu.png','During your Draw Phase, you may take the top card of the discard pile as your first draw. Any other cards you draw must come from the draw deck.',2);
INSERT INTO characters(id,name,life,image,text, game_phase, status) VALUES (8,'Kojiro',100,'characters/kojiro.png','Your Weapons can hit any Difficulty, regardless of the value on your Weapon card.',4,1);
INSERT INTO characters(id,name,life,image,text, game_phase) VALUES (9,'Musashi',100,'characters/musashi.png','If you successfully attack another character with a Weapon card, you inflict 1 additional wound. This does not apply to cards that are not Weapons, like Jujutsu.',0);
INSERT INTO characters(id,name,life,image,text) VALUES (10,'Nobunaga',100,'characters/nobunaga.png','During your Play Phase, you may discard 1 Resilience Point to draw 1 card from the deck. You may not use your last Resilience Point in this way.');
INSERT INTO characters(id,name,life,image,text) VALUES (11,'Tomoe',100,'characters/tomoe.png','Each time you successfully attack another character with a Weapon card, you draw 1 card from the deck. You only draw 1 card, even if your Weapon does more than 1 wound.');
INSERT INTO characters(id,name,life,image,text) VALUES (12,'Ushiwaka',100,'characters/ushiwaka.png','Each time you suffer a wound from a Weapon card, you draw 1 card from the deck (so 3 wounds = 3 cards).');
