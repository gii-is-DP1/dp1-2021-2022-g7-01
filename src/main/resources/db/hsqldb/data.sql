...
INSERT INTO characters(id,name,life,image,text, game_phase, status) VALUES (3,'Ginchiyo',4,'characters/ginchiyo.png','You take 1 wound less than normal when attacked by any Weapon, to a minimum of 1 wound. E.g., a Nodachi would only deal 2 wounds to you instead of 3, but a Shuriken still inflicts 1 wound.', 4,1);
...
INSERT INTO characters(id,name,life,image,text, game_phase, status) VALUES (5,'Hanzo',4,'characters/hanzo.png','You may play a Weapon card from your hand as a parry , unless it is the only card in your hand. You may use this ability even in response to cards such as Battle Cry.', 4,1);
...
INSERT INTO characters(id,name,life,image,text, game_phase, status) VALUES (8,'Kojiro',5,'characters/kojiro.png','Your Weapons can hit any Difficulty, regardless of the value on your Weapon card.',4,1);
